...
def trainer():
    ...
    classifier = train("./Dataset", model_save_path="./models/trained_model.clf", n_neighbors=3)
    print("Training complete!")
    '''
    # Evaluate accuracy and classification matrix
    evaluate_knn_accuracy("./Dataset", n_neighbors=3, verbose=True)
    
def evaluate_knn_accuracy(train_dir, n_neighbors=None, knn_algo='ball_tree', test_size=0.3, random_state=42, verbose=False):
    X = []
    y = []
